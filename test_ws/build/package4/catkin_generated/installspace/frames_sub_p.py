...
# -*- encoding: utf-8 -*-
'''
@File    :   frames_sub_p.py
@Time    :   2022/04/02 17:50:55
'''
...
"""  
    需求:
        现有坐标系统，父级坐标系统 world,下有两子级系统 son1son2
        son1 相对于 world以及 son2 相对于 world 的关系是已知的，
        求 son1 与 son2中的坐标关系又已知在 son1中一点的坐标要求求出该点在 son2 中的坐标
    实现流程:   
        1.导包
        2.初始化 ROS 节点
        3.创建 TF 订阅对象
