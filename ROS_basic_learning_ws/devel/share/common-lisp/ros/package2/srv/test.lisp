...
(cl:defmethod cl:initialize-instance :after ((m <test-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package2-srv:<test-request> is deprecated: use package2-srv:test-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <test-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package2-srv:num1-val is deprecated.  Use package2-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <test-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package2-srv:num2-val is deprecated.  Use package2-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <test-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package2-srv:<test-response> is deprecated: use package2-srv:test-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <test-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package2-srv:sum-val is deprecated.  Use package2-srv:sum instead.")
  (sum m))
