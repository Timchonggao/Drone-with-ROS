...
message(STATUS "package2: 1 messages, 1 services")

set(MSG_I_FLAGS "-Ipackage2:/home/mouwang/test_ws/src/package2/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mouwang/test_ws/src/package2/srv/test.srv" NAME_WE)
add_custom_target(_package2_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "package2" "/home/mouwang/test_ws/src/package2/srv/test.srv" ""
)

get_filename_component(_filename "/home/mouwang/test_ws/src/package2/msg/Person.msg" NAME_WE)
add_custom_target(_package2_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "package2" "/home/mouwang/test_ws/src/package2/msg/Person.msg" ""
)
...
_generate_msg_cpp(package2
  "/home/mouwang/test_ws/src/package2/msg/Person.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_cpp(package2
  "/home/mouwang/test_ws/src/package2/srv/test.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/package2
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package2)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package2\")")
  # install generated code
  install(
